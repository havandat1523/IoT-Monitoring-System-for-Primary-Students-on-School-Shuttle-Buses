...
// Gọi ra biến hspi2 đã được khởi tạo bên trong file main.c
extern SPI_HandleTypeDef hspi1;

// --- HÀM GIAO TIẾP SPI LÕI (Sử dụng HAL) ---
uint8_t TM_SPI_Send(uint8_t data) {
    uint8_t rx_data = 0;
    // Truyền 1 byte và nhận về 1 byte qua SPI2, timeout 100ms
...
// ==========================================================
// CÁC HÀM XỬ LÝ LOGIC CỦA RC522 (Giữ nguyên thuật toán gốc)
// ==========================================================

void TM_MFRC522_Init(void) {
	MFRC522_CS_HIGH(); // Đảm bảo CS ở mức cao trước khi bắt đầu
