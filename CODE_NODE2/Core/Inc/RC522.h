...
#include "main.h" // Thêm thư viện này để dùng được biến hspi2
#include <stdio.h>

#define RC522_NULL   0x00
 ...
 * Private functions
 */
extern void MFRC522_CS_LOW (void);
extern void MFRC522_CS_HIGH	(void);
extern uint8_t TM_SPI_Send(uint8_t data); // Khai báo thêm hàm giao tiếp lõi
